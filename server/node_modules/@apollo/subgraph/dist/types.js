...
function maybeAddTypeNameToPossibleReturn(maybeObject, typename) {
    if (isPromise(maybeObject)) {
        return maybeObject.then((x) => addTypeNameToPossibleReturn(x, typename));
    }
...
function withResolvedType({ type, value, context, info, callback, }) {
    var _a;
